...
The most popular tool to inject and compile these game files into **Steam** is [SteamTools](steamtools.net), there are concerns about it being unsafe so use it carefully or look into alternative injection tools.

# GreenLuma

Some people online have claimed that they were able to modify GreenLuma to inject these files into Steam and basically do the same as SteamTools, but with no concern. (Code might be hard to find or make)
...
It is pretty simple. I recommend searching for a tutorial or guide online for the type of software you use.
